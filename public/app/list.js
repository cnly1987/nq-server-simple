...
var app = {
                        ...
                        <div class="card">
                            ...
                            <div class="body" style="height:240px">
                                ...
                                <div class="col-md-12" style="padding-top:40px">
                                    ...
                                    <button class="btn btn-danger waves-effect" onclick="app.methods.delete('${data.id}')">删除</button>
                                </div>
    ...
    mounted:function(){
        loading.set()
        axios.get('/api/hosts/?limit=100').then(function(res){
            console.log(res)
            $("#surl").html(location.origin)
