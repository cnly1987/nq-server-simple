var app = {
    ...
    mounted:function(){
        loading.set()
        axios.get('/api/records/'+app.data.id+'/').then(function(res){ 
            ...
            if(is_down){
                ...
                app.methods.net_useage_chart(app.data.records.hours.results)
                app.methods.net_late_chart(app.data.records.hours.results)
                app.methods.load_chart(app.data.records.hours.results)
                app.methods.ram_chart(app.data.records.hours.results)
                app.methods.disk_chart(app.data.records.hours.results)
